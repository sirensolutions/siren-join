...
import solutions.siren.siren.join.action.coordinate.CoordinateSearchAction;
import solutions.siren.siren.join.action.coordinate.TransportCoordinateMultiSearchAction;
import solutions.siren.siren.join.action.coordinate.TransportCoordinateSearchAction;
import solutions.siren.siren.join.action.terms.TermsByQueryAction;
import solutions.siren.siren.join.action.terms.TransportTermsByQueryAction;
import solutions.siren.siren.join.index.query.BinaryTermsFilterParser;
import solutions.siren.siren.join.index.query.BinaryTermsQueryParser;
import solutions.siren.siren.join.rest.RestCoordinateMultiSearchAction;
import solutions.siren.siren.join.rest.RestCoordinateSearchAction;
