...
import com.sindicetech.kb.filterjoin.action.terms.collector.BitSetHitStream;
import com.sindicetech.kb.filterjoin.action.terms.collector.HitStream;
import com.sindicetech.kb.filterjoin.action.terms.collector.TermsCollector;
import com.sindicetech.kb.filterjoin.action.terms.collector.TopHitStream;
...
public class TransportTermsByQueryAction extends TransportBroadcastOperationAction<TermsByQueryRequest, TermsByQueryResponse, TermsByQueryShardRequest, TermsByQueryShardResponse> {
  ...
  private static abstract class OrderByShardOperation {
     ...
     * {@link com.sindicetech.kb.filterjoin.action.terms.TermsByQueryRequest.Ordering}.
     * Default to {@link com.sindicetech.kb.filterjoin.action.terms.TermsByQueryRequest.Ordering#DEFAULT}.
     */
