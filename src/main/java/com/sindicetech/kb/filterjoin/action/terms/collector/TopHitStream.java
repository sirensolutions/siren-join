...
public class TopHitStream extends HitStream {
   ...
   * {@link com.sindicetech.kb.filterjoin.action.terms.collector.TopHitStream.ScoreHit}s.
   */
  ...
  /**
   * A priority queue over the {@link com.sindicetech.kb.filterjoin.action.terms.collector.TopHitStream.ScoreHit}s.
