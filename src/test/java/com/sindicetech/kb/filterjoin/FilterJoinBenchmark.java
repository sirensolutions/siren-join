...
import com.sindicetech.kb.filterjoin.action.coordinate.CoordinateSearchRequestBuilder;
...
import static com.sindicetech.kb.filterjoin.index.query.FilterBuilders.filterJoin;
...
//        bench.benchHasParentRandomTerms();
    ...
    public void benchHasChildSingleTerm() {
        ...
        FilterJoinBuilder stringFilter = filterJoin("id")
                .indices(CHILD_INDEX)
                .types(CHILD_TYPE)
                .path("pid");

        FilterJoinBuilder longFilter = filterJoin("num")
                .indices(CHILD_INDEX)
                .types(CHILD_TYPE)
                .path("num");
    ...
    public void benchHasParentSingleTerm() {
        ...
        FilterJoinBuilder stringFilter = filterJoin("pid")
